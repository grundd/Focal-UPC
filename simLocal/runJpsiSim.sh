...
echo "Running simmulation ${i}"
    ...
    --nevents $nEvPerSim --generator Starlight --process kCohJpsiToElRad --simulation NoDigitization --focalGeometryFile geometry_02.txt \
    --ymin 3.4 --ymax 6.0
    # create the folder to store the results:
    folderName="kCohJpsiToElRad_${i}_${nEvPerSim}ev"
    mkdir -p $folderName
