...
do
    ...
    $ALIDPG_ROOT/bin/aliroot_dpgsim.sh --mode sim --run 294925 --uid $ranSeed --generator Upgrade:FOCAL_Generators:gunJpsi \
    --nevents $nEvPerSim --simulation NoDigitization --detector FOCAL --focalGeometryFile geometry_02.txt --etamin 4.6 --etamax 5.2 \
    --ptmin 4.5 --ptmax 5.5
    # create the folder to store the results:
    #folderName="BoxPhotons_${i}_${nEvPerSim}ev"
    folderName="GunJpsi_${i}_${nEvPerSim}ev"
    mkdir -p $folderName
